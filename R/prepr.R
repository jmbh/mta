  ...
  
{
  ...
  # +++ input checks +++
  stopifnot(class(data[,1])=='numeric' | class(data[,1])=='integer')
  stopifnot(class(data[,2])=='numeric' | class(data[,1])=='integer')
  stopifnot(class(data[,3])=='numeric' | class(data[,1])=='integer')
